...
$.FileDialog = function FileDialog(userOptions) {
    var options = $.extend($.FileDialog.defaults, userOptions),
        modal = $([
            ...
            "                <button type='button' class='btn btn-danger bfd-cancel'",
            "                                data-dismiss='modal'><i class='fa fa-ban'></i> ",
                                 options.cancel_button,
            "                </button>",
            "                <button type='button' class='btn btn-success bfd-ok'><i class='fa fa-check'></i> ",
                                 options.ok_button,
            "                </button>",
            "            </div>",
            "        </div>",
    ...
    var loadFile = function(f) {
        ...
        reader.onload = function(e) {
            progressBar.css ("width", "100%");  // juhegue: No finalizaba con algunos y con esto lo obligo !!!
